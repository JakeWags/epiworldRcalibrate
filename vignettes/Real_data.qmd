...
-   Add age or risk stratification for heterogeneous populations
-   Extend to SEIR model including exposed (latent) compartment
-   Include spatial structure for regional forecasting
-   Compare calibration performance with alternative methods (ABC, particle filters, MCMC)
-   Validate on out-of-sample data for true forecasting assessment
